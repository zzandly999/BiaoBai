...
public class SonComments {
    ...
    public SonComments(Long id, Date createTime, Date updateTime, Date deletedAt, Long like, Long unLike, Long numberFloor, String comment, Byte report, Long fatherCommentId, Long userRegisterId) {
        this.id = id;
        this.createTime = createTime;
        this.updateTime = updateTime;
        this.deletedAt = deletedAt;
